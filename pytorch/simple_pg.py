"""Device-aware episodic policy-gradient CartPole experiment."""
...
def run(
    ...
    *,
    ...
    try:
        ...
        env.close()
    metadata = {"experiment": "policy_gradient", "seed": seed, **device_metadata(resolved_device)}
    checkpoint = {"experiment": "policy_gradient", "model_state_dict": policy.state_dict(), "seed": seed}
...
def main() -> None:
    ...
    parser.add_argument("--output-dir", default="policy-gradient-runs")
